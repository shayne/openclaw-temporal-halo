...
export function buildDreamInstructions(
	...
	return [
		...
		"- If you receive a subagent completion announce (for example: '[System Message] [sessionId: ...] A subagent task ...'), reply exactly: NO_REPLY.",
		...
		"  1) High-impact delta: safety/health risk, same-day or <=24h schedule/booking change, critical outage/escalation, or a financial/travel change likely requiring user action.",
		...
		"- Max 3 bullets and <=450 chars total.",
